  ...
  return (
    <div className="fixed inset-0 bg-[#020205] text-slate-200 overflow-hidden font-sans select-none">
      ...
      <main className="relative z-10 w-full h-full pointer-events-none">
        ...
        {/* Action Button Layer */}
        <div className={`absolute bottom-24 lg:bottom-28 left-1/2 -translate-x-1/2 w-full max-w-[280px] lg:max-w-xs px-4 pointer-events-auto transition-all duration-700 z-20 ${isFlipping ? 'opacity-0 translate-y-20 scale-90' : 'opacity-100 translate-y-0 scale-100'}`}>
          <button
            onClick={handleFlip}
            disabled={isFlipping}
